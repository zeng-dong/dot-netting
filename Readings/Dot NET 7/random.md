...
public class Employee
{
	...
	private decimal CalsulateBonus()
	{
		return _earningsForBonus * BonusRate();
	}
...
{
	private Empoloyee _employee;

	public BonusCalculator(Employee e){ _employee = e; }

	public decimal CalculateBonus()
	{
		return CalculateEarningsForBonus() * _employee.BonusRate();
	}

	private decimal CalculateEarningsForBonus(){
	{
		return _earningsForBonus = YearToDateEarnings() + OvertimeEarnings() * 2;
	}
