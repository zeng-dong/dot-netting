...
internal class Program
{
    ...
    private static string eventHubNamespaceConnectionString = "Endpoint=sb://localhost;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=SAS_KEY_VALUE;UseDevelopmentEmulator=true;";
    private static string eventHubName = "eh1";

    static async Task Main(string[] args)
    {
        Console.WriteLine("Hello, Azure Event Hub via Emulator!");
